...
public class CheckWeatherAPIs {
	...
	public void weatherAPIResponseCode() throws InterruptedException{
				...
				("$filter", "SprayingType%20eq%20%27sw_groundspraygeneric%27%20and%20Date%20ge%20datetime%272019-06-25%27%20and%20Date%20lt%20datetime%272019-06-25%27").queryParam
				("$format", "json");
			    ...
			    System.out.println("Data received from Response " + jsonPathEvaluator.get("value.ColorCode"));
				...
				("$filter", "Date%20ge%20datetime%272019-06-25%27%20and%20Date%20lt%20datetime%272019-07-01%27%20and%20(MeasureLabel%20eq%20%27Precip_DailySum%20(mm)%27%20or%20MeasureLabel%20eq%20%27TempAir_DailyMin%20(C)%27%20or%20MeasureLabel%20eq%20%27TempAir_DailyMax%20(C)%27%20or%20MeasureLabel%20eq%20%27PictoCode_Daily%27%20or%20MeasureLabel%20eq%20%27WindDirection_DailyAvg%27%20or%20MeasureLabel%20eq%20%27WindSpeed_DailyAvg%20(m/s)%27%20or%20MeasureLabel%20eq%20%27Predictability_Daily%20(pct)%27)").queryParam
				("$format", "json");
			    ...
			    System.out.println("Data received from Response " + jsonPathEvaluator1.get("value.ColorCode"));
